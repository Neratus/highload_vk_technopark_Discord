...
| ------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1. Голосовая активность (VAD) + Шумоподавление (NS)**                  | Передача аудио только при речи пользователя с фильтрацией фонового шума (клавиатура, вентилятор, улица). | Избыточная передача аудио в моменты тишины, высокий трафик и шум в канале.                    | **VAD:** Анализ спектра и энергии сигнала для выявления речи. **NS:** Нейросетевая маска выделяет голос, подавляя несоответствующие шумы. ([источник_21])                        |
