...
## Сводка по ресурсам и хостингу (скорректировано)

| Категория            | Серверов | Всего CPU | Всего RAM   | Хостинг | Стоимость/мес (оценка) |
|----------------------|---------:|----------:|------------:|---------|------------------------:|
| Stateless (K8s)      | 60       | 3,840     | 15,360 GB   | Own     | $30,000                |
| Stateful (DB)        | 65       | 1,844     | 21,200 GB   | Own     | $32,500                |
| Infrastructure       | 96       | 5,096     | 21,376 GB   | Own     | $48,000                |
| Managed Services     | 17       | 136       | 544 GB      | Cloud   | $5,100                 |
| **Всего**            | **238**  | **10,916**| **58,480 GB**|         | **$115,600**           |
...
- **Плотность упаковки:** ~80% на Kubernetes нодах  
- **Отказоустойчивость:** N+1 для stateless, N×2 для критичных компонентов  
