...
| **profiles**          | (user_id)                    | Ускорение фильтрации и JOIN             |
| **sessions**          | (session_token), (user_id)           | Быстрый поиск сессии                    |
| **messages**          | (subchannel_id), (created_at DESC)      | Последние сообщения                     |
